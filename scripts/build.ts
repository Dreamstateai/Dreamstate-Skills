...
const BLUEPRINT_EXECUTION: Record<string, { mode: ExecutionMode; tools?: string[]; capabilityIds?: string[] }> = {
  ...
  'score-and-tier-leads': { mode: 'executable', tools: DURABLE_EXECUTION_TOOLS, capabilityIds: ['columns.add', 'columns.run', 'runs.column_get'] },
  ...
  'multi-signal-scoring': { mode: 'executable', tools: DURABLE_EXECUTION_TOOLS, capabilityIds: ['columns.add', 'columns.run', 'columns.run_all', 'runs.column_get'] },
  ...
  'build-waterfall': { mode: 'executable', tools: DURABLE_EXECUTION_TOOLS, capabilityIds: ['columns.add', 'columns.run', 'runs.column_get'] },
  'formula-and-conditions': { mode: 'executable', tools: EXECUTION_TOOLS, capabilityIds: ['columns.add', 'columns.update', 'columns.run'] },
  'merge-columns': { mode: 'executable', tools: EXECUTION_TOOLS, capabilityIds: ['columns.add', 'columns.update', 'columns.run'] },
