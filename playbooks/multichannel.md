...
capability_ids: [workbooks.create, tables.create, sources.find_leads, contacts.enrich, workflows.create, workflows.graph_apply, sequences.enroll_selection, workflows.activate, content.artifact_generate, content.schedule, social.accounts_list, outreach.workspace_stats_get]
---
