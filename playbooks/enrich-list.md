...
capability_ids: [tables.list, tables.create, sources.find_leads, contacts.list, contacts.get, contacts.enrich, tables.get, columns.add, columns.update, columns.archive, cells.settle, social.accounts_list]
---
