...
domain: connect
tier: composite
tools_used: [ping, content_list_accounts, outreach_lists]
---

# Connect Dreamstate

Dreamstate is the engine that lets you actually *do* things in the real world that
you cannot do on your own: post to LinkedIn and X, enrich leads, send connection
requests and replies, run AI-visibility probes. You reach it through the Dreamstate
MCP server. This skill makes sure that connection is live and that you have the
permissions and accounts the other playbooks assume. Running it first turns a
...
Ready for:  /dreamstate-outbound, /dreamstate-social-calendar, /dreamstate-ai-visibility
```
