# Capabilities: operating guide

## Promise

Inspect the workspace-specific capabilities available before selecting an execution path.
...
Declared capabilities: `tools.get`, `tools.search`
