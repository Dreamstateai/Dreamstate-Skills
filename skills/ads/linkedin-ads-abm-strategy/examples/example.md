# Linkedin Ads Abm Strategy: worked example

## Request

“Help me design an account-based LinkedIn advertising strategy aligned to sales coverage and buying stages.”
...
3. Explain that this is a **planned** skill.
...
Do not fabricate data, silently broaden scope, use an undeclared capability, treat a queued response as completion, or imply a planned operation executed when it did not.
