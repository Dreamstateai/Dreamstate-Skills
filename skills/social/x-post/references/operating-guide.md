# X Post: operating guide

## Promise

Write a concise X post or thread that preserves the core argument without empty compression.

## Execution boundary

Mode: **executable**. The central outcome is supported by released Dreamstate contracts.

Declared tools: `content_generate_post`

Declared capabilities: `intent:content.generate_post`

Required scopes: `content:write`
