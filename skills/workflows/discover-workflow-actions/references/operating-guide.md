# Discover Workflow Actions: operating guide
...
Declared tools: `dreamstate_tools_search`, `dreamstate_tools_get`

Declared capabilities: `tools.get`, `tools.search`, `workflows.node_options`
