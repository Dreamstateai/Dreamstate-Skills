# Build Workflow: operating guide

## Promise

Design a workflow graph with explicit inputs, branches, retries, approvals, and final outputs.
...
Declared capabilities: `workflows.create`, `workflows.graph_apply`, `workflows.node_options`, `workflows.validate_graph`
