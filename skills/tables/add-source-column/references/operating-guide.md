# Add Source Column: operating guide

## Promise

Add a provider-backed source column with validated inputs and inspectable provenance.
...
Declared tools: `dreamstate_tools_search`, `dreamstate_tools_get`, `outreach_add_column`
