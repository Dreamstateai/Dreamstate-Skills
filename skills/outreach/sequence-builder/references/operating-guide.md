...
Declared capabilities: `outreach.triggers_supported_list`, `sequences.add_step`, `sequences.edit_step`, `sequences.get`, `sequences.remove_step`, `sequences.step_options`, `sequences.validate`, `workflows.create`, `workflows.graph_apply`, `workflows.list`

Required scopes: `outreach:read`, `outreach:write`, `workflows:read`, `workflows:write`
