...
Declared capabilities: `outreach.channel_stats_get`, `outreach.dm_conversation_status_update`, `outreach.global_pause_set`, `outreach.workspace_stats_get`, `rows.query`, `sequences.edit_step`, `sequences.get`, `sequences.step_options`, `workflows.analytics_by_campaign`, `workflows.list`

Required scopes: `outreach:read`, `outreach:write`, `tables:read`, `workflows:read`
