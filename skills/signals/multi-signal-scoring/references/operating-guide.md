# Multi Signal Scoring: operating guide

## Promise

Combine several weak signals into an explainable score without double-counting correlated evidence.
...
Declared capabilities: `column:ai`, `column:formula`, `function:account_engagement_scoring`, `function:signal_triggered_outreach`
