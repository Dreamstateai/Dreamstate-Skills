# Company Event Signals: operating guide

## Promise

Monitor launches, expansions, acquisitions, leadership changes, and other company events.
...
Declared capabilities: `columns.add`, `columns.run`, `sources.list`, `table_sources.attach`, `table_sources.run`
